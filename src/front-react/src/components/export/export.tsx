    ...
    return(
        <div>
            ...
            <div className="flex flex-col px-3 py-2 m-4 bg-white">
                ...
                <a href="https://www.dropbox.com/oauth2/authorize?client_id=2175k18uazdwzb4&response_type=code" className="p-2 mt-2 font-bold text-white bg-blue-500 rounded-sm hover:bg-blue-700 focus:shadow-inner">Link your accout</a>
            </div>
